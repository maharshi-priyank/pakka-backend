...
export const validationSchema = Joi.object({
  ...
  CALENDLY_CLIENT_ID:      Joi.string().optional(),
  CALENDLY_CLIENT_SECRET:  Joi.string().optional(),
  CALENDLY_REDIRECT_URI:   Joi.string().optional(),
  CALENDLY_WEBHOOK_SECRET: Joi.string().optional(),
...
export const configuration = () => ({
  ...
  calendly: {
    ...
    redirectUri:   process.env.CALENDLY_REDIRECT_URI ?? 'http://localhost:3000/api/v1/auth/calendly/callback',
