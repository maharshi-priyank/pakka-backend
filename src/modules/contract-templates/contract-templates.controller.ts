...
// U2/KTD1: every route below resolves resolveWorkspaceId(user) -- never the
...
export class ContractTemplatesController {
  ...
  fromContract(
    ...
    @Body() dto: FromContractDto,
  ) {
    return this.templates.fromContract(resolveWorkspaceId(user), contractId, dto);
  }
}
