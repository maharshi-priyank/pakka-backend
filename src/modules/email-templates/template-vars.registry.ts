...
const COMMON_INVOICE_VARS: TemplateVarMeta[] = [
  ...
  { name: 'viewUrl',       description: 'Link to view invoice in portal', sample: 'https://app.clinekt.io/portal/...' },
...
export const TEMPLATE_REGISTRY: TemplateKeyMeta[] = [
  ...
  },
  {
    ...
    vars: [
      ...
      { name: 'businessName',  description: 'Your business name',            sample: 'Studio Rao'     },
      { name: 'viewUrl',       description: 'Link to portal',                sample: 'https://app.clinekt.io/portal/...' },
    ],
  },
  ...
  // ── Proposal ────────────────────────────────────────────────────────────────
  {
    ...
    vars: [
      ...
      { name: 'proposalUrl',  description: 'Link to view proposal',     sample: 'https://app.clinekt.io/p/...'   },
      { name: 'businessName', description: 'Your business name',        sample: 'Studio Rao'                     },
    ],
  },
  {
    ...
    vars: [
      ...
      { name: 'proposalUrl',   description: 'Link to proposal',    sample: 'https://app.clinekt.io/p/...' },
      { name: 'businessName',  description: 'Your business name',  sample: 'Studio Rao'                   },
    ],
  },
  {
  ...
  // ── Contract ────────────────────────────────────────────────────────────────
  {
    ...
    vars: [
      ...
      { name: 'signUrl',       description: 'Link to sign contract',  sample: 'https://app.clinekt.io/sign/...'    },
      { name: 'businessName',  description: 'Your business name',     sample: 'Studio Rao'                         },
    ],
  },
  ...
  // ── Lead ────────────────────────────────────────────────────────────────────
  {
    ...
    vars: [
      ...
      { name: 'leadUrl',   description: 'Link to the lead',        sample: 'https://app.clinekt.io/app/leads/...' },
    ],
  },
  {
  ...
  // ── Digest ───────────────────────────────────────────────────────────────────
  {
    ...
    vars: [
      ...
      { name: 'reportUrl',     description: 'Link to GST report',     sample: 'https://app.clinekt.io/app/reports' },
    ],
  },
  {
    key: 'weekly_digest',
    ...
    vars: [
      ...
      { name: 'dashboardUrl',   description: 'Dashboard link',             sample: 'https://app.clinekt.io/app/dashboard' },
    ],
  },
  {
    key: 'monthly_summary',
